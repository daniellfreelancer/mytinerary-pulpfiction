    ...
    <>
        <div className="comment-box">
            <div className="Comment-div">
                <button className="Comment-button" onClick={showActivity}>
                    Activities{" "}
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" className="bi bi-clipboard2-heart" viewBox="0 0 16 16">
                ...
                </button>
                {
                  show ? (
                    ...
                    { 
                      activitiesDetail ? ( activitiesDetail?.map((e) => {
                            return (
