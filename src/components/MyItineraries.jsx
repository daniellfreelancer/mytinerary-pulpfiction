...
function MyItineraries() {
    ...
    const arrayUsers = [
        {
            id: "63127d65bd5df3158d31150a",
            name: "Daniel"
        },
        {
            id: "63127d66bd5df3158d31150c",
            name: "Cinthya"
        },
        {
            id: "63127d66bd5df3158d31150b",
            name: "Naty"
        },
        {
            id: "631262a13be9ab609930ecfa",
            name: "Erze"
        },
  ...
  return (
    <>
        <div className='Mytineraries-div-title'>
            <h2>My Tineraries</h2>
            <h3>{myitinerariesDetail?.[0].user.name}</h3>
            ...
            <select onChange={handleSelect} >
                <option>Select an User</option>
                {
                    arrayUsers.map((user)=>{
                        return (
                            <option key={user.id} id={user.id} value={user.id}> {user.name} </option>
                        )
                    })
                }
