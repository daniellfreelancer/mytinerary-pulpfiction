  ...
  return (
    <div className='CityCard-container' >

        {
            itineraries.map((e)=>{
                return (
                    <div className="paper" key={e.id} >
                    <img className="poster" src={e.img} alt={e.city} />
                    <h2 className="title-city">{e.city}</h2>
                    <hr/>
                    <p className="p-city">{e.smalldescription}</p>
                    <LinkRouter to='*' className="btn-read">Discover!</LinkRouter>
                </div>
                )
            })
        }
